...
export class Const {
  ...
  public static readonly ItemStatsTypeIcons = new Collection<ItemStatsTypeEnum, string>([
    [ItemStatsTypeEnum.Attack, '<:Attack:822949617242603530>'],
  ]);
  public static readonly ItemTypeIcons = new Collection<ItemTypeEnum, string>([
    [ItemTypeEnum.Weapon, '<:Weapon:822919374364082268>'],
  ]);
}
